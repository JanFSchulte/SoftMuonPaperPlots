...
#~ 
	...
	idNames = {"softMVARun3XGBSoft": "MIT XGB Soft", "softMVARun3XGBLoose": "MIT XGB Loose", "softMVARun3XGBMedium": "MIT XGB Medium", "softMVARun3XGBTight": "MIT XGB Tight"}
	...
	yRanges = {"softMVARun3XGBSoft": [0.9,1.05], "softMVARun3XGBLoose": [0.8,1.0], "softMVARun3XGBMedium": [0.65,0.9], "softMVARun3XGBTight": [0.35,0.75]}
	...
	for abseta in absetabins:
		...
		for i in range(0,len(ids)):
			...
			canv.Print("SoftMuonEff_Eras_abseta_%s_%s.pdf"%(abseta,id))
			canv.Print("SoftMuonEff_Eras_abseta_%s_%s.png"%(abseta,id))
	...
	for id in ids:
		...
		canv.Print("SoftMuonEff_Eras_%s_vsEta.pdf"%(id))
		canv.Print("SoftMuonEff_Eras_%s_vsEta.png"%(id))
