...
#~ 
	...
	ids = ["softMVARun3HGBSoft", "softMVARun3HGBLoose", "softMVARun3HGBMedium", "softMVARun3HGBTight"]
	idNames = {"softMVARun3HGBSoft": "HGB Soft", "softMVARun3HGBLoose": "HGB Loose", "softMVARun3HGBMedium": "HGB Medium", "softMVARun3HGBTight": "HGB Tight"}
	idColors = {"softMVARun3HGBSoft": ROOT.kMagenta, "softMVARun3HGBLoose": ROOT.kBlue, "softMVARun3HGBMedium": ROOT.kGreen+1, "softMVARun3HGBTight": ROOT.kRed}
	...
	for era in eras:
		...
		for abseta in absetabins:
			...
			canv.Print("SoftMuonEff_HGBWPs_abseta_%s_%s.pdf"%(abseta,era))
			canv.Print("SoftMuonEff_HGBWPs_abseta_%s_%s.png"%(abseta,era))
		...
		canv.Print("SoftMuonEff_HGBWPs_%s_vsEta.pdf"%(era))
		canv.Print("SoftMuonEff_HGBWPs_%s_vsEta.png"%(era))
