...
#~ 
	...
	ids = [ "softMVARun2", "softMVARun3HGBMedium", "softMVARun3XGBMedium"]
	idNames = {"softID": "cut-based soft ID", "softMVARun2": "Run 2 soft MVA ID", "softMVARun3HGBMedium": "HGB Medium", "softMVARun3XGBMedium": "XGB Medium", "softMVARun3Weight": "Purdue HGB pT weighted"}
	idColors = {"softID": ROOT.kGray, "softMVARun2": ROOT.kBlue, "softMVARun3HGBMedium": ROOT.kGreen+1, "softMVARun3XGBMedium": ROOT.kRed, "softMVARun3Weight": ROOT.kGreen+1}
	...
	for era in eras:
		...
		for abseta in absetabins:
			...
			canv.Print("SoftMuonEff_abseta_%s_%s.pdf"%(abseta,era))
			canv.Print("SoftMuonEff_abseta_%s_%s.png"%(abseta,era))
		...
		canv.Print("SoftMuonEff_%s_vsEta.pdf"%(era))
		canv.Print("SoftMuonEff_%s_vsEta.png"%(era))
