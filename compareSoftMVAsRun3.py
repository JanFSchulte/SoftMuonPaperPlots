...
#~ 
	...
	idNames = {"softID": "cut-based soft ID", "softMVARun2": "Run 2 soft MVA ID", "softMVARun3": "Purdue HGB", "softMVARun3XGBMedium": "XGB Medium", "softMVARun3HGBMedium": "HGB Medium"}
	...
	for abseta in absetabins:
		...
		canv.Print("SoftMuonEff_abseta_%s_Run3.pdf"%(abseta))
		canv.Print("SoftMuonEff_abseta_%s_Run3.png"%(abseta))
	...
	canv.Print("SoftMuonEff_Run3_vsEta.pdf")
	canv.Print("SoftMuonEff_Run3_vsEta.png")
